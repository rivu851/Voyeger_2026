...
import { Star, MapPin, Phone, Mail, Package, Truck, Shield } from "lucide-react"
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">{product.vendorDetails.email}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Phone className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">{product.vendorDetails.phone}</span>
                </div>
              </div>
            </div>
